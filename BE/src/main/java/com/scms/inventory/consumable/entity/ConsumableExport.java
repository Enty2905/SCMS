...
@Entity
@Table(name = "consumable_export")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@FieldDefaults(level = AccessLevel.PRIVATE)
public class ConsumableExport {
    ...
    @OneToMany(mappedBy = "consumableExport", cascade = CascadeType.ALL, orphanRemoval = true)
    @Builder.Default
    List<ConsumableExportItem> items = new ArrayList<>();
